...
export const paginatedQuerySchema = z.object({
  ...
  takeAll: z.coerce
    ...
    .optional()
    .default(false)
    .describe('Whether to take all items without pagination'),
})
...
export const infiniteQuerySchema = z.object({
  cursor: z
    .string()
    .optional()
    .describe('The cursor for infinite scrolling pagination'),
  limit: z.coerce
    .number()
    .min(1)
    .max(100)
...
export const paginatedMetaSchema = z.object({
  ...
  nextPage: z
    .number()
    .nullable()
    .describe('The next page number, or null if on the last page'),
  previousPage: z
    .number()
    .nullable()
    .describe('The previous page number, or null if on the first page'),
})
...
export const infiniteMetaSchema = z.object({
  startCursor: z
    .string()
    .nullable()
    .describe('The cursor at the start of the current page'),
  endCursor: z
    .string()
    .nullable()
    .describe('The cursor at the end of the current page'),
  hasNextPage: z
    .boolean()
    .describe('Indicates if there is a next page available'),
  hasPreviousPage: z
    .boolean()
    .describe('Indicates if there is a previous page available'),
})
