...
export function getCategoryDetailController(deps: {
  getCategoryDetailUseCase: IGetCategoryDetailUseCase
}) {
...
export type IGetCategoryDetailController = ReturnType<
  typeof getCategoryDetailController
>
