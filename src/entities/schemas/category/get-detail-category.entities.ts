...
export const getDetailCategoryQuerySchema = z.discriminatedUnion('by', [
  z.object({
    ...
    identifier: z
      .string()
      .min(1)
      .describe('The unique identifier of the category'),
  }),
  z.object({
    by: z.literal('name'),
...
export type GetDetailCategoryQuery = z.infer<
  typeof getDetailCategoryQuerySchema
>
...
export const getDetailCategoryResponseSchema = baseResponseSchema.extend({
  ...
  updatedBy: z
    ...
    .optional()
    .describe(
      'The user ID who last updated the category, null if never updated',
    ),
})

export type GetDetailCategoryResponse = z.infer<
  typeof getDetailCategoryResponseSchema
>
